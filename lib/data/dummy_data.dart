...
const availableCategories = [
  ...
  Category(id: 'c11', title: 'Comfort Food', color: Colors.brown),
  Category(id: 'c12', title: 'International Fusion', color: Colors.limeAccent),
];
...
const dummyMeals = [
  ...
  Meal(
    ...
    complexity: Complexity.simple,
    imageUrl:
        'https://upload.wikimedia.org/wikipedia/commons/c/c5/Cheeseburger.jpg',
    duration: 15,
    ingredients: [
      '200g Ground Beef',
      '1 Burger Bun',
    ...
    steps: [
      ...
      'Grill or fry the patty to your preferred doneness.',
      'Toast the burger bun lightly.',
      'Assemble the burger with lettuce, tomato, onion, patty, and cheese.',
      'Add your favorite condiments and serve.',
    ],
    isGlutenFree: false,
    isVegan: false,
    isVegetarian: false,
  ...
  Meal(
    ...
    complexity: Complexity.challenging,
    imageUrl:
        'https://upload.wikimedia.org/wikipedia/commons/6/63/Vegetable_Stir_Fry.jpg',
    duration: 30,
    ingredients: [
      '1 Broccoli Floret',
      '2 Carrots',
  ...
  Meal(
    id: 'm4',
    categories: ['c7', 'c10'],
    title: 'Pancakes with Fresh Berries',
    affordability: Affordability.pricey,
    complexity: Complexity.simple,
    imageUrl:
        'https://upload.wikimedia.org/wikipedia/commons/4/4c/Pancakes_with_berries.jpg',
    duration: 25,
    ingredients: [
      '2 Cups of Flour',
      '1 Cup of Milk',
  ...
  Meal(
    ...
    complexity: Complexity.simple,
    imageUrl:
        'https://upload.wikimedia.org/wikipedia/commons/6/6b/Mac_and_Cheese.jpg',
    duration: 30,
    ingredients: [
      '200g Elbow Macaroni',
      '100g Cheddar Cheese',
    ...
    steps: [
      ...
      'In a saucepan, melt butter and stir in flour to create a roux.',
      'Slowly add milk to the roux while stirring to avoid lumps.',
      'Add cheddar and parmesan cheese to the sauce and mix until melted.',
  ...
  Meal(
    ...
    complexity: Complexity.challenging,
    imageUrl:
        'https://upload.wikimedia.org/wikipedia/commons/0/0f/Sushi_Burrito.jpg',
    duration: 40,
    ingredients: [
      '2 Cups of Sushi Rice',
      'Nori Sheets',
      '100g Raw Salmon (or Tuna)',
      'Cucumber',
      'Avocado',
      'Soy Sauce',
      'Sriracha (optional)',
    ...
    steps: [
      'Cook sushi rice and season it with vinegar.',
      'Lay out a nori sheet and spread a thin layer of rice.',
      'Add salmon or tuna, cucumber, avocado, and any other fillings.',
      'Roll tightly into a burrito shape.',
      'Cut into halves and serve with soy sauce and sriracha.',
    ],
    isGlutenFree: true,
    isVegan: false,
    isVegetarian: false,
